...
static unsafe class TurnKey
{
  ...
  static void ScanKeyboard(int pixels, Keys key)
  {
    if (IsPressed(key))
    {
      ...
      if (current_time - last_turn_time > one_second)
      {
        ...
        Console.WriteLine("Совершен поворот {0}", current_time);
      }
    }
  }
  ...
  static void Main(string[] argv)
  {
    ...
    Console.WriteLine("Левый поворот на {0} пикселей.", pixels);
    Console.WriteLine("Активация поворота кнопкой \"{0}\".", key);
